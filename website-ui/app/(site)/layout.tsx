        ...
        <footer className="border-t border-zinc-900/80 bg-black/40">
          <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8 py-10 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
            ...
            <div className="space-y-2">
              ...
              <Link className="block text-zinc-400 hover:text-zinc-200" href="/financas">Finanças</Link>
              <Link className="block text-zinc-400 hover:text-zinc-200" href="/cripto">Cripto</Link>
              <Link className="block text-zinc-400 hover:text-zinc-200" href="/product">Produto</Link>
