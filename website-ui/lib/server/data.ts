...
export async function readSiteFinanceSnapshot() {
  ...
  return {
    ...
    data_quality: {
      price_source: "bundle",
      price_history_start: null,
      price_history_end: null,
      ingestion_status: "missing",
      backfill_status: "missing",
      backfill_targeted_assets: null,
      backfill_deferred_review_tickers: [],
      smoke_test_status: "missing",
      watchdog_status: "missing",
      last_ingestion_at: null,
      last_ingestion_data_date: null,
      ingestion_updated_assets: null,
      ingestion_failed_assets: null,
      volume_supported_assets: 0,
      volume_total_assets: 0,
