...
def main() -> None:
    ...
    shadow_gods_step = _run_step([sys.executable, "scripts/ops/run_daily_shadow_gods_agent.py", "--cycle-run-id", cycle_run_id], timeout_sec=1200.0)
    ...
    operation["post_steps"] = {
        ...
        "daily_shadow_gods": shadow_gods_step,
        "site_snapshot": snapshot_step,
    }
    operation["publish_ready"] = bool(registry_step["ok"] and data_quality_step["ok"] and shadow_gods_step["ok"] and snapshot_step["ok"])
